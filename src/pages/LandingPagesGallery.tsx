...
const landingPages = [
	{
		...
		description:
			"Modern e-commerce landing page with 40% conversion rate improvement",
	...
	},
	{
		...
		description:
			"SaaS landing page with focus on feature showcase and user onboarding",
	...
	},
	{
		...
		description:
			"Award-winning agency landing page with interactive portfolio showcase",
	...
	},
	{
		...
		description:
			"Medical practice landing page increasing patient appointments by 180%",
	...
	},
	{
		...
		description:
			"Investment platform landing page with advanced analytics dashboard",
	...
	},
	{
		...
		description:
			"EdTech landing page driving 250% increase in course enrollments",
	...
	},
	{
		...
		description:
			"Engaging welcome email sequence with 85% open rate and improved onboarding",
	...
	},
	{
		...
		description:
			"Modern newsletter design increasing subscriber engagement by 60%",
	...
	},
	{
		...
		description:
			"Product promotion email template boosting sales conversion by 45%",
	...
	},
	{
		...
		description:
			"Professional event invitation design with 70% RSVP response rate",
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-4">
							<Button
								variant="ghost"
								size="sm"
								onClick={() => navigate("/?fromGallery=1")}
						...
						<div className="p-6">
							<div className="flex items-start justify-between mb-4">
								...
								{selectedImage.liveUrl !== "#" && (
									<Button
										onClick={() =>
											window.open(selectedImage.liveUrl, "_blank")
										}
